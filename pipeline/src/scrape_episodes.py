...
def output_path(global_number: int, title: str, wiki_title: str | None = None) -> Path:
    slug = title_to_page_name(wiki_title or title)
...
def scrape_season(season: int) -> None:
    ...
    for episode in episodes:
        wiki_title = episode.get("wiki_title") or episode["title"]
        path = output_path(episode["global_number"], episode["title"], wiki_title)
